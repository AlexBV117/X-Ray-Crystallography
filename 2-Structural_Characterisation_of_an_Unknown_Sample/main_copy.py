...
for peak in peaks:
    ax1.axvline(peak, linestyle='dashed', c=(0.5, 0.5, 0.5))
ax1.plot(angles, scan, marker=".", c='k', linestyle="solid")
ax1.set_title("Bragg Scan of an Unknown Sample")
ax1.set_xlabel("Angle θ (°)")
ax1.set_ylabel("Counts per second (10 second average)")
ax1.set_yscale("log")
plt1.savefig("Bragg_Scan_2.png")
...
ax2.plot(angles2, fit_line, linestyle="dotted", c=(0.5, 0.5, 0.5), label=f"Fit line slope: {lattice:.2f} ± {error:.2f} Å")
ax2.scatter(value_pairs[0], value_pairs[1], c='k')
ax2.set_title("Value pairs as a function of sin θ")
ax2.set_xlabel("sin θ")
ax2.set_ylabel("nλ/pm")
ax2.legend(loc="upper left") 
plt2.savefig("value_Pairs_2.png")
